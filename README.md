...
- Semantic Versioning (10.1.2) [major.minor.patch]
- Major(Umuman eski qism olib tashlab, yangi qismlar qoshilganda)
- Minor(added new feature, remove old feature)
- Patch(simple bugs: ui, mini feature)
- Example: v1.0.0 -> v1.0.1 -> v1.1.0 -> v2.0.0

### 1. Introduction to Git & Version Control

- What is Version Control and why is it important? 👍
- Difference between Git and "gitlab" "github" "bit becket" 👍
